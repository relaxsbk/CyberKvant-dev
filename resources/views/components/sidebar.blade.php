    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-[#1E1E1E] space-y-6">
            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <!-- Категории -->
                    <div>
                        <button id="categoryButton" class="w-full px-4 py-2 text-left text-gray-900 dark:text-white flex items-center justify-between dark:hover:bg-[#2B2D2D] rounded-[10px] duration-300" onclick="toggleAccordion('categoryAccordion', 'categoryArrow', 'categoryButton')">
                            <div class="flex items-center">
                    ...
                    <!-- Бренды -->
                    <div>
                        <button id="brandButton" class="w-full px-4 py-2 text-left text-gray-900 dark:text-white flex items-center justify-between dark:hover:bg-[#2B2D2D] rounded-[10px] duration-300" onclick="toggleAccordion('brandAccordion', 'brandArrow', 'brandButton')">
                            <div class="flex items-center">
                    ...
                    <!-- Товары -->
                    <div>
                        <button id="productButton" class="w-full px-4 py-2 text-left text-gray-900 dark:text-white flex items-center justify-between dark:hover:bg-[#2B2D2D] rounded-[10px] duration-300" onclick="toggleAccordion('productAccordion', 'productArrow', 'productButton')">
                            <div class="flex items-center">
