...
@section('adminMain')
    ...
    <x-breadcrumb>
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-500">Неопубликованные бренды</span>
            </div>
        </li>
    </x-breadcrumb>
    ...
    @if($brands->isEmpty())
        <h2 class="text-3xl mt-12 mb-6 text-center">К сожалению брендов нет...</h2>
    @else
