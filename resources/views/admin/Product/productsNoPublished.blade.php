    ...
    <x-breadcrumb>
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-500">Неопубликованные товары</span>
            </div>
        </li>
    </x-breadcrumb>

    <h1 class="text-4xl mt-3 ">Список всех неопубликованных товаров</h1>
    {{-- Modal create --}}
