...
<template>
    <section class="container mx-auto mt-10 ">
        ...
        <section>
            <div class="h-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 py-1 mb-[30px]">
                <CategoryCard
            ...
            <p class="text-xl mb-[30px]">{{props.brand.description}}</p>
        </section>
