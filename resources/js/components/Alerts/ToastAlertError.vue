...
<template>
    <Transition name="fade">
        <div v-if="isVisible" :key="errorKey" class="fixed z-[100] flex items-center w-full max-w-xs p-4 space-x-4 text-gray-500 divide-x rtl:divide-x-reverse rounded-lg shadow-sm right-5 bottom-5 dark:text-gray-400 divide-[#292929] bg-[#292929]" role="alert">
