...
<template>
    <nav class="bg-[#1E1E1E] fixed w-full z-50">
        <div class="container mx-auto flex items-center justify-between p-4">
            ...
            <div class="flex-shrink-0 visible block xl:hidden " >
            ...
            <ul class="hidden lg:flex space-x-6 items-center text-white">
                <li>
                    <a href="#" class="flex flex-col items-center">
                        ...
                        <span class="hover:text-secondary-purple">Сравнить</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex flex-col items-center">
                        ...
                        <span class="hover:text-secondary-purple">Избранное</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex flex-col items-center">
                        ...
                        <span class="hover:text-secondary-purple">Корзина</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex flex-col items-center">
                        ...
                        <span class="hover:text-secondary-purple">Аккаунт</span>
                    </a>
                </li>
            </ul>
