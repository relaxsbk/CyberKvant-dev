    ...
    <nav class="bg-[#1E1E1E] fixed w-full z-30">
        <div class="container mx-auto flex items-center justify-between py-4">
            ...
            <div class="text-[16px] ml-7 hidden lg:block">
                <Link
                    :href="$route('catalog')"
                    class="bg-primary-purple text-white px-4 py-3 rounded-[10px] flex items-center duration-200 active:bg-dark-purple hover:bg-dark-purple/80"
                    :class="{'bg-dark-purple': $page.url === '/catalog'}"
                >
            ...
            <ul class="hidden lg:flex space-x-6 items-center text-white">
                <li>
                    <Link :href="$route('compare')" class="flex flex-col items-center hoverText">
                ...
                <li>
                    <Link :href="$route('favorites')" class="flex flex-col items-center hoverText">
                ...
                <li>
                    <Link :href="$route('basket')" class="flex flex-col items-center hoverText">
